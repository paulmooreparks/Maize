...
namespace {
    ...
    std::unordered_map<std::string, opcode_data> opcodes {
        ...
        { "SETE",   {cpu::instr::setz_opcode   , opcode_1param_tokenizer, reg_compiler}},
        { "SETNE",  {cpu::instr::setnz_opcode  , opcode_1param_tokenizer, reg_compiler}},
        { "SETL",   {cpu::instr::setlt_opcode  , opcode_1param_tokenizer, reg_compiler}},
        { "SETNGE", {cpu::instr::setlt_opcode  , opcode_1param_tokenizer, reg_compiler}},
        { "SETNL",  {cpu::instr::setge_opcode  , opcode_1param_tokenizer, reg_compiler}},
        { "SETG",   {cpu::instr::setgt_opcode  , opcode_1param_tokenizer, reg_compiler}},
        { "SETNLE", {cpu::instr::setgt_opcode  , opcode_1param_tokenizer, reg_compiler}},
        { "SETNG",  {cpu::instr::setle_opcode  , opcode_1param_tokenizer, reg_compiler}},
        { "SETC",   {cpu::instr::setb_opcode   , opcode_1param_tokenizer, reg_compiler}},
        { "SETNAE", {cpu::instr::setb_opcode   , opcode_1param_tokenizer, reg_compiler}},
        { "SETNC",  {cpu::instr::setae_opcode  , opcode_1param_tokenizer, reg_compiler}},
        { "SETNB",  {cpu::instr::setae_opcode  , opcode_1param_tokenizer, reg_compiler}},
        { "SETNBE", {cpu::instr::seta_opcode   , opcode_1param_tokenizer, reg_compiler}},
        { "SETNA",  {cpu::instr::setbe_opcode  , opcode_1param_tokenizer, reg_compiler}},
