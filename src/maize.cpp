...
static void print_usage(std::ostream &out) {
	out <<
		...
		"'maizeg' also syncs each frame to the monitor by default (--no-vsync turns it off):\n"
		"the on-screen rate then follows the display, and --refresh-hz sets only the guest\n"
		...
		"\n"
		"Optional operator files under ~/.maize (HOME, or USERPROFILE if HOME is\n"
		"unset or empty) tune startup:\n"
