...
int main() {
	...
	std::vector<maize::byte> code {
	    ...
	    /* LD $00 G */              cpu::instr::ld_immVal_reg, 0x00, 0x50, 0x00,
		/* LD 0x00002100 H.H0 */	cpu::instr::ld_immVal_reg, 0x02, 0x6C, 0x00, 0x21, 0x00, 0x00,
		/* LD 0x01 J */				cpu::instr::ld_immVal_reg, 0x00, 0x70, 0x01,
		/* SYS $00 */				cpu::instr::sys_immVal, 0x00, 0x00,
		/* LD $01 G */				cpu::instr::ld_immVal_reg, 0x00, 0x50, 0x01,
		/* LD 0x00002100 H.H0 */	cpu::instr::ld_immVal_reg, 0x02, 0x6C, 0x00, 0x21, 0x00, 0x00,
		/* LD 0x01 J */				cpu::instr::ld_immVal_reg, 0x00, 0x70, 0x01,
		/* SYS $01 */				cpu::instr::sys_immVal, 0x00, 0x01,
