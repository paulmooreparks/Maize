...
# the mzcc.cmd forwarder block in install-mzasm.ps1), same as build-quesos.ps1 /
# build-userland.ps1 / build-demos.ps1. Fail fast with a clear message rather than a raw .NET exception when
