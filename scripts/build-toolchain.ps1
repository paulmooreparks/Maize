...
if (-not $wsl) {
    Write-Error 'WSL is required to build the C toolchain (it is POSIX-only) but wsl.exe was not found on PATH. Install WSL, or build from an MSYS2 shell instead.'
    exit 2
}
