...
.DESCRIPTION
    ...
    provisioned (run scripts\install-mzasm.ps1 -WithCToolchain once to set that up;
    the plain install builds only the v2 binaries since maize-454). If Git Bash is
