...
function Invoke-Test($test) {
    ...
    # pass/fail (see the relaxed-EAP smoke probes in scripts/install-mzasm.ps1 for the
    # same idiom; cited by name rather than by line, which maize-454 moved).
    ...
    # as the mazm call above and the relaxed-EAP smoke probes in
