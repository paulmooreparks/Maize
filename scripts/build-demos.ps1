...
# that. maize-265 removed that re-root, so the script now runs in place against the real
# tree on every host. Fail fast with a clear message rather than a raw .NET exception
# when bash.exe cannot be found.
